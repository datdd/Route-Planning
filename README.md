...
```
git clone https://github.com/udacity/Route-Planning.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:udacity/Route-Planning.git --recurse-submodules
```
 ...
 * If you are working on windows and unable to install IO2D:
      ...
      * If you are still facing errors, visit this [link](https://github.com/udacity/Route-Planning/issues/9).
